    ...
    return (
        <div className="w-full py-2 bg-[#f8f9fa] border-b-2 md:flex md:items-center justify-between gap-3 flex-col md:flex-row">
            ...
            <div className="block md:hidden fixed right-4 top-4"
                ...
                {
                    isMenuOpen ? <IoMdClose size={23} /> : <FiMenu size={23} /> 
                } </div>
            <ul className={
                `flex gap-1 mr-3 flex-col md:flex-row h-auto mt-3 md:top-3 md:right-0 md:mt-0 ${!isMenuOpen ? "fixed top-[-9999px] border-t-white" : ""
                }`
            }>
                {
                    isLoggedIn && (
